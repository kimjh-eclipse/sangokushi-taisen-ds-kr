<p class="badges">
  <img src="https://img.shields.io/badge/버전-v20260711-9e1b1b" alt="버전">
...
2. [패치 파일](https://github.com/kimjh-eclipse/sangokushi-taisen-ds-kr/releases/download/v20260711/SGS_kr_patch_v20260711.xdelta)을 내려받아 xdelta(또는 xdeltaUI, Delta Patcher 등)로 적용합니다.

   ```bash
   xdelta -d -s "San Goku Shi Taisen (J).nds" SGS_kr_patch_v20260711.xdelta "San Goku Shi Taisen (K).nds"
   ```
3. 적용 결과를 확인합니다 (선택).
   - 한국어판 MD5: `5b5645292977364a420506c8c732d4a2`
   - 패치 파일 MD5: `d7e5be717e2966aeb5e30183bcca3666`
...
| 경로 | 내용 |
|---|---|
| `SGS_kr_patch_v20260711.xdelta` | 한국어 패치 본체 (최신) |
